        ...
        <section className="py-12 md:py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl text-pretty animate-slide-up">
              Explore our comprehensive range of genuine motor spare parts and
              professional car maintenance products. Connect with us on
              Instagram and Facebook for the latest updates.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-gradient-to-r from-primary/10 to-primary/5 border border-primary/20 rounded-xl p-8 md:p-12 text-center animate-slide-up">
              ...
              <p className="text-muted-foreground mb-8 text-lg max-w-2xl mx-auto">
                Stay connected with Ozidi Zuba in Kubwa for the latest product
                arrivals, special offers, maintenance tips, and automotive
                industry insights.
              </p>
