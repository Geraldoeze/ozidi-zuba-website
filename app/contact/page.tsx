...
export const metadata: Metadata = {
  ...
  description: 'Contact Ozidi Zuba in Kubwa for motor spare parts inquiries. Reach us via WhatsApp, phone, or visit our store in Kubwa, Abuja.',
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center space-y-4 animate-slide-up">
              ...
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                Have questions about our products? We&apos;re here to help. Contact us via WhatsApp for instant response.
              </p>
            </div>
          </div>
        </section>
              ...
              <div className="space-y-6">
                ...
                <div className="p-6 bg-card rounded-xl border border-border/50 hover:border-primary/50 transition-all group">
                  ...
                  <p className="text-muted-foreground text-sm mb-4">
                    Fastest way to reach us. Send us a message and get instant response.
                  </p>
                  <a
                ...
                <div className="p-6 bg-card rounded-xl border border-border/50 hover:border-primary/50 transition-all group">
                  ...
                  <a href="tel:+234" className="text-primary hover:text-primary/80 font-medium text-sm">
                    +234...
                  </a>
                </div>
            ...
            <div className="mt-16">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="p-6 bg-card rounded-xl border border-border/50">
                  ...
                  <p className="text-muted-foreground text-sm">
                    We accept cash, bank transfers, and mobile money payments. Contact us for more details on payment options.
                  </p>
                </div>

                <div className="p-6 bg-card rounded-xl border border-border/50">
                  <h3 className="font-semibold text-lg mb-3">Do you deliver outside Abuja?</h3>
                  <p className="text-muted-foreground text-sm">
                    Yes! We can arrange delivery to other parts of Nigeria. Kindly contact us via WhatsApp for delivery rates.
                  </p>
                </div>

                <div className="p-6 bg-card rounded-xl border border-border/50">
                  <h3 className="font-semibold text-lg mb-3">Do you offer warranties?</h3>
                  <p className="text-muted-foreground text-sm">
                    All our products come with the manufacturer&apos;s warranty. Specific warranty terms vary by product.
                  </p>
                </div>
                ...
                <div className="p-6 bg-card rounded-xl border border-border/50">
                  ...
                  <p className="text-muted-foreground text-sm">
                    In Abuja, we offer same-day delivery for orders placed early. Other locations may take 2-5 business days.
                  </p>
                </div>

                <div className="p-6 bg-card rounded-xl border border-border/50">
                  <h3 className="font-semibold text-lg mb-3">Can I return or exchange products?</h3>
                  <p className="text-muted-foreground text-sm">
                    Yes, we have a return policy for unopened products. Contact us to discuss your specific situation.
                  </p>
                </div>

                <div className="p-6 bg-card rounded-xl border border-border/50">
                  <h3 className="font-semibold text-lg mb-3">How do I know if a part fits my vehicle?</h3>
                  <p className="text-muted-foreground text-sm">
                    Send us your vehicle details and the part you need via WhatsApp. Our experts will confirm compatibility.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="py-16 md:py-24 bg-card">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
              Click the button below to chat with us on WhatsApp. We&apos;re available 24/7 to answer your questions.
            </p>
            <a
              href="https://wa.me/234"
              target="_blank"
