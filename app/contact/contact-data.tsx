            ...
            <div className="grid md:grid-cols-3 gap-8 mb-16">
              ...
              <div className="space-y-6">
                ...
                <div className="p-6 bg-card rounded-xl border border-border/50 hover:border-primary/50 transition-all group">
                  ...
                  <a
                    href="https://maps.google.com/?q=9.146791,7.335326"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-primary hover:text-primary/80 font-medium text-sm flex items-center gap-2 group/link"
                  >
              ...
              <div className="md:col-span-2">
                <div className="p-8 bg-card rounded-xl border border-border/50">
                  ...
                  <div className="rounded-xl overflow-hidden border border-border/50 ">
                    <iframe
                      src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3939.8!2d7.3353259!3d9.1467915!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zOcKwMDgnNDguNSJOIDfCsDIwJzA3LjIiRQ!5e0!3m2!1sen!2sng!4v1700000000000!5m2!1sen!2sng"
                      width="100%"
                      height="400"
                      style={{ border: 0 }}
                      allowFullScreen
                      ...
                      title="Our Location - 208 Bakori Road PW, Kubwa Abuja"
                      className="w-full"
                    />
                  </div>
                </div>
