...
export const metadata: Metadata = {
  ...
  description:
    "Genuine motor spare parts, car maintenance products, and auto accessories in Abuja. Engine filters, brake systems, electrical components, and more.",
  keywords:
    "motor spare parts Abuja, car maintenance products, auto accessories, engine filters, brake pads, suspension parts, electrical components",
  alternates: {
...
const products = [
  {
    ...
    description:
      "Quality engine filters for optimal vehicle performance and longevity.",
    items: [
      "Engine air filters",
      "Oil filters",
      "Cabin air filters",
  ...
  },
  {
    ...
    description:
      "Complete cooling system components to keep your engine at the right temperature.",
    items: [
      "Radiators",
      "Cooling fans",
      "Thermostats",
  ...
  },
  {
    ...
    description:
      "Components for safe handling and comfortable driving experience.",
    items: [
      "Shock absorbers",
      "Tie rods",
      "Control arms",
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center space-y-5 animate-slide-up">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-tight text-balance">
                Comprehensive range of genuine motor spare parts and car
              ...
              <div className="space-y-4">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      All products are authentic and sourced from trusted
                      manufacturers.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Each product meets international quality standards and
                      specifications.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Best prices for quality products without compromising on
                      standards.
                    </p>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Our team provides professional advice on product selection
                      and installation.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Comprehensive selection covering all major vehicle types
                      and models.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Quick turnaround on orders with reliable delivery options
                      available.
                    </p>
                  </div>
                </div>
        ...
        <section className="py-16 md:py-24 bg-card">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
              Contact us via WhatsApp with your vehicle details and part
              requirements. Our team will help you find exactly what you need.
            </p>
            <a
