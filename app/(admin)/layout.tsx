...
// const ALLOWED_EMAILS = ["ezenagugerald@gmail.com", "client@email.com"];
...
//   // currentUser() gives you the full user object including email
...
//       {/* <nav className="sticky top-0 z-50 bg-background border-b px-4 py-3 flex items-center justify-between"> */}
//       <nav className="sticky top-0 z-50 border-b bg-background/80 backdrop-blur-xl">
//         <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
//           <div className="flex items-center gap-3">
//             <Link href="/admin" className="font-bold text-primary text-sm">
//               Gallery CMS
//             </Link>
...
//       <div className="fixed bottom-0 left-0 right-0 z-50 bg-background border-t flex md:hidden">
//         <Link
//           href="/admin"
//           className="flex-1 flex flex-col items-center py-3 gap-1 text-xs text-muted-foreground hover:text-primary transition-colors"
//         >
//           <svg
